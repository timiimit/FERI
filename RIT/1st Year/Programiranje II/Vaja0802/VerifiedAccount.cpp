...
std::string VerifiedAccount::toJSON()
{
	std::stringstream ss;
	ss << "{ \"id\": " << id << ", \"username\": \"" << username << "\", \"password\": \"" << password << "\", \"person\": " << person->toJSON() << ", \"verificationType\": \"" << verificationType << "\", \"verificationInfo\": \"" << verificationInfo << "\", \"verificationDate\": " << verificationDate.toJSON() << " }";
	return ss.str();
}
